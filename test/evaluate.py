...
if __name__ == '__main__':
    for t in range(50):
        ...
        model = load_model("glstm{0!s}.hdf5".format(t), custom_objects={'GraphLSTM': GraphLSTM,
                                                       'GraphLSTMCell': GraphLSTMCell})
        raw_model = load_model("glstm_raw{0!s}.hdf5".format(t), custom_objects={'GraphLSTM': GraphLSTM,
                                                       'GraphLSTMCell': GraphLSTMCell})
        ...
        for img_batch_start in tqdm(
            ...
            for index, shape in enumerate(scale_list):
                ...
                io.imsave(OUTPUT_PATH + image_names[index] + "_{0!s}.png".format(t), output)
